...
class DrillHydrogen(Building, ConsumingBuilding, ProducingBuilding, MiningBuilding):

    def __init__(self, position):
        Building.__init__(self, position, ALL_BUILDINGS_SETTINGS[BuildingsName.DRILL_HYDROGEN])
