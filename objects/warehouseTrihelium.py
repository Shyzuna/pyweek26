...
class WarehouseTriHelium(Building, ProducingBuilding, StockingBuilding):
    ...
    def __init__(self, position):
        ...
        Building.__init__(self, self.position, ALL_BUILDINGS_SETTINGS[BuildingsName.WAREHOUSE_TRIHELIUM])

        self.state = BuildingStates.ON
        ProducingBuilding.__init__(self, self.network, self.buildingData, self.state, self.level)
        StockingBuilding.__init__(self, self.network, self.buildingData, ObjectCategory.TRIHELIUM, self.level)
